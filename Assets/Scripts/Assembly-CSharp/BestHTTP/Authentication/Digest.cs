                    ...
                    case AuthenticationTypes.Digest:
                        {
                            ...
                            else if (text3.Contains("auth-int"))
                            {
                                ...
                                string text4 = string.Format("{0}:{1}:{2}", request.MethodType.ToString().ToUpper(), request.CurrentUri.GetRequestPathAndQueryURL(), array.CalculateMD5Hash()).CalculateMD5Hash();
                            ...
                            string text6 = string.Format("Digest username=\"{0}\", realm=\"{1}\", nonce=\"{2}\", uri=\"{3}\", cnonce=\"{4}\", response=\"{5}\"", credentials.UserName, Realm, Nonce, request.Uri.GetRequestPathAndQueryURL(), text, empty2);
                            if (text3 != null)
                            {
